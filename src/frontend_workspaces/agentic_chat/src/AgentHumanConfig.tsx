...
export default function AgentHumanConfig({ onClose }: AgentHumanConfigProps) {
	...
	const removeRule = (id: string) => {
		setConfig({
			...config,
			interventionRules: config.interventionRules.filter(
				(r) => r.id !== id,
			),
		});
	};
	...
	const getAutonomyColor = (level: 1 | 2 | 3) => {
		switch (level) {
			case 1:
				return "#10b981"; // Green for safest (always asks)
			case 2:
				return "#f59e0b"; // Orange for moderate
			case 3:
				return "#ef4444"; // Red for riskiest (rarely asks)
			default:
				return "#f59e0b";
		}
	};
					...
					<div className="config-card">
						...
						<div className="config-form">
							<div className="form-group">
								...
								<small>
									Slide left for maximum safety (agent always
									asks) or right for higher risk but faster
									results
								</small>
							</div>
							...
							<div className="form-row">
								<div className="form-group">
									<label className="checkbox-label">
										<input
											type="checkbox"
											checked={
												config.autoApproveSimpleTasks
											}
											onChange={(e) =>
												setConfig({
													...config,
													autoApproveSimpleTasks:
														e.target.checked,
												})
											}
								...
								<div className="form-group">
									...
									<small>
										Agent can escalate complex issues to
										human
									</small>
								</div>
							</div>
							...
							<div className="confirmation-grid">
								<label className="checkbox-label">
									...
									<div>
										...
										<small>
											Agent must get approval before
								...
								<label className="checkbox-label">
									...
									<div>
										...
										<small>
											Tasks estimated to take more than 5
											minutes
										</small>
									</div>
								</label>
					...
					<div className="config-card">
						...
						{config.interventionRules.length === 0 ? (
							<div className="policies-empty">
								No intervention rules defined. Add conditions
								when the agent should return control to a human.
							</div>
						) : (
						...
						<small>
							Define specific scenarios when the agent should
					...
					<div className="config-card">
						...
						<div className="config-form">
							<div className="form-group">
								...
								<small>
									Agent learns from interactions and adjusts
									autonomy over time
								</small>
							</div>
							...
							<div className="adaptive-learning-info">
								<p className="info-text">
									With adaptive learning, the agent starts
									cautious and gradually becomes more
									autonomous as it learns from successful
									interactions and builds confidence through
									memory.
								</p>
							</div>
							...
							<div className="form-group">
								...
								<small>
									Agent asks frequently at first, then reduces
									questions as it learns
								</small>
							</div>
							...
							<div className="form-row">
								<div className="form-group">
									...
									<small>
										Use past interactions from memory to
										inform decisions
									</small>
								</div>
								...
								<div className="form-group">
									...
									<small>
										Monitor and learn from successful vs.
										corrected actions
									</small>
								</div>
							</div>
							...
							<div className="form-group">
								...
								/>
								<small>
									Number of interactions required before agent
									starts adapting
								</small>
							</div>
							...
							<div className="learning-examples">
								...
								<ul className="learning-bullets">
									<li>
										<strong>First Time:</strong> Agent asks
										for confirmation on most actions
									</li>
									<li>
										<strong>After Success:</strong> If
										action succeeds and you approve,
										confidence increases
									</li>
									<li>
										<strong>Pattern Recognition:</strong>{" "}
										Agent learns from similar past
										situations in memory
									</li>
									<li>
										<strong>Gradual Autonomy:</strong> Over
										time, agent stops asking for familiar
										tasks
									</li>
									<li>
										<strong>Context Aware:</strong> Still
										asks for new or high-risk situations
									</li>
								</ul>
							</div>
						</div>
