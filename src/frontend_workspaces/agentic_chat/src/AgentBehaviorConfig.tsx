...
export default function AgentBehaviorConfig({
	onClose,
					...
					<div className="config-card">
						...
						<div className="config-form">
							<div className="form-group">
								<label className="checkbox-label">
									<input
										...
										onChange={(e) =>
											setSettings({
												...settings,
												useVisionOnUI: e.target.checked,
											})
										}
									/>
								...
								<small>
									Enable vision capabilities for understanding
									and interacting with user interfaces. When
									enabled, the agent will use visual models to
								...
								<label className="checkbox-label">
									<input
										...
										onChange={(e) =>
											setSettings({
												...settings,
												useSOMOnWeb: e.target.checked,
											})
										}
									/>
									<span>
										Use Set of Marks (SOM) on Web Actions
									</span>
								</label>
								<small>
									Enable Set of Marks technique for web
									interactions. SOM helps the agent identify
									and interact with specific elements on web
							...
							<div className="form-group">
								...
								<select
									...
									onChange={(e) =>
										setSettings({
											...settings,
											decompositionStrategy: e.target
												.value as BehaviorSettings["decompositionStrategy"],
										})
									}
									style={{
										width: "100%",
								...
								<small>
									Choose how the agent breaks down complex
									tasks:
									<br />
									<strong>Sequential:</strong> Execute tasks
									one after another in order
									<br />
									<strong>Parallel:</strong> Execute
									independent tasks simultaneously
									<br />
									<strong>Hierarchical:</strong> Break down
									into subtasks with dependencies
									<br />
									<strong>Adaptive:</strong> Automatically
									choose the best strategy based on task
									complexity
								</small>
							</div>
						</div>
