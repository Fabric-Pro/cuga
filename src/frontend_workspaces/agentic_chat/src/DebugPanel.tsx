			...
			{isOpen && (
				<div className="debug-panel-content">
					...
					<div className="debug-section">
						...
						{error && (
							<div className="debug-error">Error: {error}</div>
						)}
						{agentState && (
							<div className="debug-state-content">
								...
								{agentState.state ? (
									<>
										<div className="debug-state-item">
											...
											>
												{agentState.state.lite_mode ===
												null
													? "Not Set (using settings)"
													: agentState.state.lite_mode
														? "True (Fast/Lite)"
														: "False (Balanced)"}
											</span>
								...
								{Object.keys(agentState.variables).length >
									0 && (
