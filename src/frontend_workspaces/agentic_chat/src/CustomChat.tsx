...
export function CustomChat({
	...
	useEffect(() => {
		const handleVariablesUpdate = ((event: CustomEvent) => {
			console.log(
				"[CustomChat] Received variablesUpdate event:",
				event.detail,
			);
			...
			if (onVariablesUpdate) {
				...
				console.warn(
					"[CustomChat] onVariablesUpdate callback is not defined!",
				);
			}
		}) as EventListener;
		...
		if (typeof window !== "undefined") {
			console.log(
				"[CustomChat] Setting up variablesUpdate event listener",
			);
			window.addEventListener("variablesUpdate", handleVariablesUpdate);
			return () => {
				console.log(
					"[CustomChat] Cleaning up variablesUpdate event listener",
				);
	...
	useEffect(() => {
		...
		if (typeof window !== "undefined") {
			console.log(
				"[CustomChat] Setting up finalAnswerComplete event listener",
			);
	...
	const handleSend = async () => {
		...
		try {
			...
			if (!currentThreadId) {
				...
				threadIdRef.current = newThreadId;
				console.log(
					"[CustomChat] Generated new threadId:",
					newThreadId,
				);
			...
			console.log(
				"[CustomChat] Sending message with threadId:",
				finalThreadId,
			);
	...
	const handleKeyPress = (e: React.KeyboardEvent<HTMLDivElement>) => {
		...
		if (isInsideChip) {
			...
			if (e.key === "Backspace" || e.key === "Delete") {
				...
				if (
					range?.commonAncestorContainer?.parentNode instanceof
					HTMLElement
				) {
					chipElement =
						range.commonAncestorContainer.parentNode.closest(
							".inline-file-reference",
						);
				}
				if (
		...
		if (showFileAutocomplete && filteredFiles.length > 0) {
			if (e.key === "ArrowDown") {
				...
				setSelectedFileIndex(
					(prev) => (prev + 1) % filteredFiles.length,
				);
				return;
			}
				...
				<div className="welcome-screen">
							...
							<div className="welcome-content">
								<div className="welcome-header">
									...
									<p className="mission-text">
										Intelligent task automation through
										multi-agent orchestration, API
										integration, and code generation on
								...
								<div className="demo-apps-section">
									<div className="section-header">
										<h2 className="section-title">
											Connected Apps and Tools for This
											Demo
										</h2>
									</div>
									...
									<div className="demo-apps-grid">
										<div className="demo-app-card crm-card">
											...
											<div className="demo-app-card-content">
												<h3 className="demo-app-name">
													CRM System
												</h3>
												<p className="demo-app-tools">
													20 Tools Available
												</p>
												<div className="demo-app-examples">
													<span className="demo-app-tag">
														Get Accounts
													</span>
													<span className="demo-app-tag">
														Get Contacts
					...
					<div className="welcome-features-section">
						<div className="section-header">
							...
							<p className="section-subtitle">
								Powerful features that make CUGA an intelligent
								automation platform
							</p>
						</div>
						...
						<div className="welcome-features">
							<div className="feature-card">
								...
								<p className="feature-description">
									CUGA orchestrates specialized agents for
									planning, coding & execution
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									CUGA writes and runs Python code in secure
									sandbox
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									Users can connect any OpenAPI or MCP server
									instantly
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									Users can ask followup questions on
									variables in memory and previous
									conversations
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									CUGA works with small models and open source
									models like GPT OSS 120B and Llama 4
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									CUGA executes both web and API tasks
									seamlessly
								</p>
							</div>
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									Users can configure reasoning modes: lite,
									balanced
								</p>
							</div>
						</div>
					...
					{!hasStartedChat && (
						<div className="welcome-features-section">
							<div className="section-header">
								...
								<p className="section-subtitle">
									Powerful features that make CUGA an
							...
							<div className="welcome-features">
								...
								<div className="feature-card">
									...
									<p className="feature-description">
										CUGA writes and runs Python code in
										secure sandbox
									</p>
								</div>
								...
								<div className="feature-card">
									...
									<p className="feature-description">
										Users can connect any OpenAPI or MCP
										server instantly
									</p>
								</div>
								...
								<div className="feature-card">
									...
									<p className="feature-description">
										CUGA tracks variables and data across
										conversations
									</p>
								</div>
							</div>
