...
function B() {
			...
			if ((e && typeof e == "object") || typeof e == "function")
				for (let s of a(e))
					!h.call(r, s) &&
						...
						o(r, s, {
							get: () => e[s],
							enumerable: !(i = l(e, s)) || i.enumerable,
						});
			return r;
		},
		M = (r, e, t) => (
			...
			m(
				!r || !r.__esModule
					? o(t, "default", { value: r, enumerable: !0 })
					: t,
				r,
			)
		),
		O = (r) => m(o({}, "__esModule", { value: !0 }), r),
		n = (r, e, t) => (k(r, typeof e != "symbol" ? e + "" : e, t), t),
		P = {};
	x(P, { default: () => v }), (y = O(P));
	var E = M(w()),
		d = C();
	...
	class v extends E.Component {
		...
		async load(e) {
			...
			if (
				!(
					(t = globalThis.customElements) != null &&
					t.get("mux-player")
				)
			)
				try {
					const c = R.replace("VERSION", s.version);
					await D(() => import(`${c}`), []), this.props.onLoaded();
				} catch (c) {
					i(c);
				}
			const [, f] = e.match(d.MATCH_URL_MUX);
			this.player.playbackId = f;
		}
		play() {
		...
		render() {
			...
			return (
				s === !1 && (b["--controls"] = "none"),
				E.default.createElement("mux-player", {
					ref: this.ref,
	...
	return n(v, "displayName", "Mux"), n(v, "canPlay", d.canPlay.mux), y;
}
var I = B();
const T = j(I),
	q = S({ __proto__: null, default: T }, [I]);
export { q as M };
