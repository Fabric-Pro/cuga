...
function yr(n) {
	...
	for (r = 0, e = 0; r < i; r += 4, e += 3)
		(t =
			(m[n.charCodeAt(r)] << 18) |
			(m[n.charCodeAt(r + 1)] << 12) |
			(m[n.charCodeAt(r + 2)] << 6) |
			m[n.charCodeAt(r + 3)]),
			(u[a++] = (t >> 16) & 255),
			(u[a++] = (t >> 8) & 255),
			(u[a++] = t & 255);
	return (
		o === 2
			? ((t = (m[n.charCodeAt(r)] << 2) | (m[n.charCodeAt(r + 1)] >> 4)),
				(u[a++] = t & 255))
			: o === 1 &&
				((t =
					(m[n.charCodeAt(r)] << 10) |
					(m[n.charCodeAt(r + 1)] << 4) |
					(m[n.charCodeAt(r + 2)] >> 2)),
				(u[a++] = (t >> 8) & 255),
				(u[a++] = t & 255)),
		u
	);
...
function N(n, r, e, i, t) {
	var o,
		...
		d = n[r + s];
	for (
		s += x, o = d & ((1 << -h) - 1), d >>= -h, h += c;
		h > 0;
		o = o * 256 + n[r + s], s += x, h -= 8
	);
	for (
		u = o & ((1 << -h) - 1), o >>= -h, h += i;
		h > 0;
		u = u * 256 + n[r + s], s += x, h -= 8
	);
	if (o === 0) o = 1 - l;
	else {
...
function A(n, r) {
	...
	return (
		f.TYPED_ARRAY_SUPPORT
			? ((n = new Uint8Array(r)), (n.__proto__ = f.prototype))
			: (n === null && (n = new f(r)), (n.length = r)),
		n
	);
}
function f(n, r, e) {
	if (!f.TYPED_ARRAY_SUPPORT && !(this instanceof f)) return new f(n, r, e);
	if (typeof n == "number") {
		if (typeof r == "string")
			throw new Error(
...
f.TYPED_ARRAY_SUPPORT &&
	...
	typeof Symbol < "u" && Symbol.species && f[Symbol.species]);
function Z(n) {
	if (typeof n != "number")
...
function v(n, r) {
	...
	n = A(n, e);
	for (var i = 0; i < e; i += 1) n[i] = r[i] & 255;
	return n;
}
function Rr(n, r, e, i) {
	...
	return (
		e === void 0 && i === void 0
			...
			: i === void 0
				...
				: (r = new Uint8Array(r, e, i)),
		f.TYPED_ARRAY_SUPPORT
			? ((n = r), (n.__proto__ = f.prototype))
			: (n = v(n, r)),
		n
	);
}
function Tr(n, r) {
	...
	if (r) {
		if (
			...
			return typeof r.length != "number" || Wr(r.length)
				? A(n, 0)
				: v(n, r);
		if (r.type === "Buffer" && K(r.data)) return v(n, r.data);
	}
	throw new TypeError(
...
f.concat = function (r, e) {
	...
	var i;
	if (e === void 0) for (e = 0, i = 0; i < r.length; ++i) e += r[i].length;
...
f.prototype.swap16 = function () {
	...
	for (var e = 0; e < r; e += 2) I(this, e, e + 1);
	return this;
};
f.prototype.swap32 = function () {
	...
	for (var e = 0; e < r; e += 4) I(this, e, e + 3), I(this, e + 1, e + 2);
	return this;
};
...
f.prototype.compare = function (r, e, i, t, o) {
	...
	if (
		...
		e < 0 || i > r.length || t < 0 || o > this.length)
	)
	...
	if (typeof r == "number")
		return (
			...
			typeof Uint8Array.prototype.indexOf == "function"
				? t
					? Uint8Array.prototype.indexOf.call(n, r, e)
					: Uint8Array.prototype.lastIndexOf.call(n, r, e)
				: j(n, [r], e, i, t)
		);
...
f.prototype.write = function (r, e, i, t) {
	if (e === void 0) (t = "utf8"), (i = this.length), (e = 0);
	else if (i === void 0 && typeof e == "string")
		(t = e), (i = this.length), (e = 0);
	else if (isFinite(e))
		(e = e | 0),
			isFinite(i)
				? ((i = i | 0), t === void 0 && (t = "utf8"))
				: ((t = i), (i = void 0));
	else
		throw new Error(
	...
	if (
		((i === void 0 || i > o) && (i = o),
		(r.length > 0 && (i < 0 || e < 0)) || e > this.length)
	)
...
function Nr(n) {
	var r = n.length;
	if (r <= z) return String.fromCharCode.apply(String, n);
	for (var e = "", i = 0; i < r; )
		e += String.fromCharCode.apply(String, n.slice(i, (i += z)));
	return e;
}
function Or(n, r, e) {
	var i = "";
	e = Math.min(n.length, e);
	for (var t = r; t < e; ++t) i += String.fromCharCode(n[t] & 127);
	return i;
}
function qr(n, r, e) {
	var i = "";
	e = Math.min(n.length, e);
	for (var t = r; t < e; ++t) i += String.fromCharCode(n[t]);
	return i;
}
function br(n, r, e) {
	var i = n.length;
	(!r || r < 0) && (r = 0), (!e || e < 0 || e > i) && (e = i);
	for (var t = "", o = r; o < e; ++o) t += $r(n[o]);
	return t;
}
function Mr(n, r, e) {
...
f.prototype.slice = function (r, e) {
	...
	if (f.TYPED_ARRAY_SUPPORT)
		...
		var o = e - r;
		t = new f(o, void 0);
		for (var u = 0; u < o; ++u) t[u] = this[u + r];
	}
	return t;
};
function p(n, r, e) {
...
f.prototype.writeUInt8 = function (r, e, i) {
	return (
		(r = +r),
		(e = e | 0),
		i || g(this, r, e, 1, 255, 0),
		f.TYPED_ARRAY_SUPPORT || (r = Math.floor(r)),
		(this[e] = r & 255),
		e + 1
	);
};
function O(n, r, e, i) {
	...
	for (var t = 0, o = Math.min(n.length - e, 2); t < o; ++t)
		n[e + t] =
			(r & (255 << (8 * (i ? t : 1 - t)))) >>> ((i ? t : 1 - t) * 8);
}
f.prototype.writeUInt16LE = function (r, e, i) {
	return (
		(r = +r),
		(e = e | 0),
		i || g(this, r, e, 2, 65535, 0),
		f.TYPED_ARRAY_SUPPORT
...
f.prototype.writeIntLE = function (r, e, i, t) {
	...
	for (this[e] = r & 255; ++u < i && (c *= 256); )
		r < 0 && a === 0 && this[e + u - 1] !== 0 && (a = 1),
			(this[e + u] = (((r / c) >> 0) - a) & 255);
	return e + i;
};
...
f.prototype.writeInt32LE = function (r, e, i) {
	return (
		(r = +r),
		(e = e | 0),
		i || g(this, r, e, 4, 2147483647, -2147483648),
		f.TYPED_ARRAY_SUPPORT
			? ((this[e] = r & 255),
				(this[e + 1] = r >>> 8),
				(this[e + 2] = r >>> 16),
...
f.prototype.copy = function (r, e, i, t) {
	...
	t > this.length && (t = this.length),
		r.length - e < t - i && (t = r.length - e + i);
	var o = t - i,
		u;
	if (this === r && i < e && e < t)
		for (u = o - 1; u >= 0; --u) r[u + e] = this[u + i];
	else if (o < 1e3 || !f.TYPED_ARRAY_SUPPORT)
		for (u = 0; u < o; ++u) r[u + e] = this[u + i];
	else Uint8Array.prototype.set.call(r, this.subarray(i, i + o), e);
	return o;
};
f.prototype.fill = function (r, e, i, t) {
	if (typeof r == "string") {
		if (
			(typeof e == "string"
				? ((t = e), (e = 0), (i = this.length))
				: typeof i == "string" && ((t = i), (i = this.length)),
			r.length === 1)
		) {
	...
	var u;
	if (typeof r == "number") for (u = e; u < i; ++u) this[u] = r;
	else {
		var c = _(r) ? r : Y(new f(r, t).toString()),
			a = c.length;
		for (u = 0; u < i - e; ++u) this[u + e] = c[u % a];
	}
	return this;
};
...
function Jr(n) {
	for (var r = [], e = 0; e < n.length; ++e) r.push(n.charCodeAt(e) & 255);
	return r;
}
function Vr(n, r) {
...
const jr = 46,
	...
	ar = function (n) {
		...
		if (Array.isArray(n)) {
			const r = [];
			for (const e of n)
				if (typeof e == "string") r.push({ key: e, header: e });
				else if (
					typeof e == "object" &&
					e !== null &&
					!Array.isArray(e)
			...
			const r = [];
			for (const e in n) r.push({ key: e, header: n[e] });
			n = r;
		}
		return [void 0, n];
	};
...
const oe = function (n) {
	...
	lr = function (n) {
		...
		if (r.delimiter === void 0 || r.delimiter === null) r.delimiter = ",";
		else if (T(r.delimiter)) r.delimiter = r.delimiter.toString();
		...
		if (r.quote === void 0 || r.quote === null) r.quote = '"';
		else if (r.quote === !0) r.quote = '"';
		else if (r.quote === !1) r.quote = "";
		else if (T(r.quote)) r.quote = r.quote.toString();
		...
		if (
			((r.quoted === void 0 || r.quoted === null) && (r.quoted = !1),
			r.escape_formulas === void 0 || r.escape_formulas === null)
		)
			r.escape_formulas = !1;
		...
		if (
			((r.quoted_empty === void 0 || r.quoted_empty === null) &&
				(r.quoted_empty = void 0),
			r.quoted_match === void 0 ||
			r.quoted_match === null ||
			r.quoted_match === !1
				? (r.quoted_match = null)
				: Array.isArray(r.quoted_match) ||
					(r.quoted_match = [r.quoted_match]),
			r.quoted_match)
		)
		...
		if (
			((r.quoted_string === void 0 || r.quoted_string === null) &&
				(r.quoted_string = !1),
			(r.eof === void 0 || r.eof === null) && (r.eof = !0),
			r.escape === void 0 || r.escape === null)
		)
			r.escape = '"';
		else if (T(r.escape)) r.escape = r.escape.toString();
		...
		if (
			((r.columns = i),
			(r.quoted === void 0 || r.quoted === null) && (r.quoted = !1),
			(r.cast === void 0 || r.cast === null) && (r.cast = {}),
			(r.cast.bigint === void 0 || r.cast.bigint === null) &&
				(r.cast.bigint = (t) => "" + t),
			(r.cast.boolean === void 0 || r.cast.boolean === null) &&
				(r.cast.boolean = (t) => (t ? "1" : "")),
			(r.cast.date === void 0 || r.cast.date === null) &&
				(r.cast.date = (t) => "" + t.getTime()),
			(r.cast.number === void 0 || r.cast.number === null) &&
				(r.cast.number = (t) => "" + t),
