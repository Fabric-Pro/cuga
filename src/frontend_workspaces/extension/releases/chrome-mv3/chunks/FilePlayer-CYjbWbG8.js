...
function J() {
	...
	var u = Object.create,
		...
		I = (s, e, t) =>
			e in s
				...
				: (s[e] = t),
		D = (s, e) => {
			for (var t in e) h(s, t, { get: e[t], enumerable: !0 });
		},
		b = (s, e, t, r) => {
		...
		w = (s, e, t) => (
			...
			b(
				!s || !s.__esModule
					? h(t, "default", { value: s, enumerable: !0 })
					: t,
				s,
			)
		),
		M = (s) => b(h({}, "__esModule", { value: !0 }), s),
		i = (s, e, t) => (I(s, typeof e != "symbol" ? e + "" : e, t), t),
		_ = {};
	D(_, { default: () => g }), (S = M(_));
	var P = w(q()),
		a = X(),
	...
	const E = typeof navigator < "u",
		...
		O =
			E &&
			(/iPad|iPhone|iPod/.test(navigator.userAgent) || k) &&
			!window.MSStream,
		U =
			E &&
			/^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
			!window.MSStream,
		F = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js",
		N = "Hls",
		j =
			"https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js",
		H = "dashjs",
		V = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js",
		T = "flvjs",
		C = /www\.dropbox\.com\/.+/,
		m = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/,
		B = "https://videodelivery.net/{id}/manifest/video.m3u8";
	class g extends P.Component {
		constructor() {
			super(...arguments),
				i(this, "onReady", (...e) => this.props.onReady(...e)),
				i(this, "onPlay", (...e) => this.props.onPlay(...e)),
				i(this, "onBuffer", (...e) => this.props.onBuffer(...e)),
				i(this, "onBufferEnd", (...e) => this.props.onBufferEnd(...e)),
				i(this, "onPause", (...e) => this.props.onPause(...e)),
				i(this, "onEnded", (...e) => this.props.onEnded(...e)),
				i(this, "onError", (...e) => this.props.onError(...e)),
				i(this, "onPlayBackRateChange", (e) =>
					this.props.onPlaybackRateChange(e.target.playbackRate),
				),
				i(this, "onEnablePIP", (...e) => this.props.onEnablePIP(...e)),
				i(this, "onDisablePIP", (e) => {
				...
				i(this, "renderSourceElement", (e, t) =>
					typeof e == "string"
						? P.default.createElement("source", { key: t, src: e })
						: P.default.createElement("source", { key: t, ...e }),
				),
				i(this, "renderTrack", (e, t) =>
					P.default.createElement("track", { key: t, ...e }),
				),
				i(this, "ref", (e) => {
					this.player && (this.prevPlayer = this.player),
						(this.player = e);
				});
		}
		componentDidMount() {
			...
			e && (this.player.src = e),
				(O || this.props.config.forceDisableHls) && this.player.load();
		}
		...
		shouldUseAudio(e) {
			return e.config.forceVideo || e.config.attributes.poster
				? !1
				: v.AUDIO_EXTENSIONS.test(e.url) || e.config.forceAudio;
		}
		shouldUseHLS(e) {
			return (U && this.props.config.forceSafariHLS) ||
				this.props.config.forceHLS
				? !0
				: O || this.props.config.forceDisableHls
					? !1
					: v.HLS_EXTENSIONS.test(e) || m.test(e);
		}
		shouldUseDASH(e) {
		...
		load(e) {
			...
			if (
				...
				this.shouldUseHLS(e) &&
					(0, a.getSDK)(F.replace("VERSION", t), N).then((n) => {
						if (
							((this.hls = new n(r)),
				...
				this.shouldUseDASH(e) &&
					(0, a.getSDK)(j.replace("VERSION", o), H).then((n) => {
						(this.dash = n.MediaPlayer().create()),
				...
				this.shouldUseFLV(e) &&
					(0, a.getSDK)(V.replace("VERSION", L), T).then((n) => {
						(this.flv = n.createPlayer({ type: "flv", url: e })),
							this.flv.attachMediaElement(this.player),
							this.flv.on(n.Events.ERROR, (l, c) => {
		...
		render() {
			const {
				...
				x = this.shouldUseAudio(this.props) ? "audio" : "video",
				K = {
					width: l === "auto" ? l : "100%",
					height: c === "auto" ? c : "100%",
				};
	...
	return (
		i(g, "displayName", "FilePlayer"), i(g, "canPlay", v.canPlay.file), S
	);
}
var R = J();
const $ = G(R),
	ee = z({ __proto__: null, default: $ }, [R]);
export { ee as F };
