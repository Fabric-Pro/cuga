			...
			if ((e && typeof e == "object") || typeof e == "function")
				for (const a of o(e))
					!u.call(r, a) &&
						...
						n(r, a, {
							get: () => e[a],
							enumerable: !(i = p(e, a)) || i.enumerable,
						});
			return r;
		},
		E = (r, e, t) => (
			...
			b(
				!r || !r.__esModule
					? n(t, "default", { value: r, enumerable: !0 })
					: t,
				r,
			)
		),
		S = (r) => b(n({}, "__esModule", { value: !0 }), r),
		f = (r, e, t) => (I(r, typeof e != "symbol" ? e + "" : e, t), t),
		y = {};
	j(y, { default: () => C }), (v = S(y));
	var l = E(k());
	const h = "64px",
		...
		fetchImage({ url: e, light: t, oEmbedUrl: i }) {
			if (!l.default.isValidElement(t)) {
				...
				return (
					...
					window
						.fetch(i.replace("{url}", e))
						.then((a) => a.json())
						.then((a) => {
							if (a.thumbnail_url && this.mounted) {
								const d = a.thumbnail_url
...
var x = q();
const A = D(x),
	R = M({ __proto__: null, default: A }, [x]);
export { R as P };
