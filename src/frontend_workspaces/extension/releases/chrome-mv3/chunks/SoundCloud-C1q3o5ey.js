import { a as T, g as N } from "./sidepanel-DjwwbR2c.js";
...
function U() {
			...
			if ((e && typeof e == "object") || typeof e == "function")
				for (let a of i(e))
					!d.call(t, a) &&
						...
						s(t, a, {
							get: () => e[a],
							enumerable: !(c = p(e, a)) || c.enumerable,
						});
			return t;
		},
		S = (t, e, r) => (
			...
			y(
				!t || !t.__esModule
					? s(r, "default", { value: t, enumerable: !0 })
					: r,
				t,
			)
		),
		C = (t) => y(s({}, "__esModule", { value: !0 }), t),
		o = (t, e, r) => (v(t, typeof e != "symbol" ? e + "" : e, r), r),
		_ = {};
	O(_, { default: () => h }), (f = C(_));
	var m = S(T()),
		P = x(),
		w = A();
	const j = "https://w.soundcloud.com/player/api.js",
		E = "SC";
	class h extends m.Component {
		constructor() {
			super(...arguments),
				o(this, "callPlayer", P.callPlayer),
				o(this, "duration", null),
				o(this, "currentTime", null),
				o(this, "fractionLoaded", null),
				o(this, "mute", () => {
					this.setVolume(0);
				}),
				o(this, "unmute", () => {
		...
		load(e, r) {
			(0, P.getSDK)(j, E).then((c) => {
				...
				r ||
					((this.player = c.Widget(this.iframe)),
					this.player.bind(a, this.props.onPlay),
					this.player.bind(R, () => {
					...
					this.player.bind(M, (u) => this.props.onError(u))),
					this.player.load(e, {
	...
	return (
		o(h, "displayName", "SoundCloud"),
		o(h, "canPlay", w.canPlay.soundcloud),
		o(h, "loopOnEnded", !0),
		f
	);
}
var b = U();
const V = N(b),
	K = q({ __proto__: null, default: V }, [b]);
export { K as S };
