...
function N() {
			...
			if ((e && typeof e == "object") || typeof e == "function")
				for (const r of n(e))
					!c.call(t, r) &&
						...
						i(t, r, {
							get: () => e[r],
							enumerable: !(l = u(e, r)) || l.enumerable,
						});
			return t;
		},
		k = (t, e, a) => (
			...
			b(
				!t || !t.__esModule
					? i(a, "default", { value: t, enumerable: !0 })
					: a,
				t,
			)
		),
		R = (t) => b(i({}, "__esModule", { value: !0 }), t),
		s = (t, e, a) => (O(t, typeof e != "symbol" ? e + "" : e, a), a),
		f = {};
	C(f, { default: () => h }), (P = R(f));
	var m = k(I()),
		y = x(),
		g = A();
	const D = "https://fast.wistia.com/assets/external/E-v1.js",
		E = "Wistia",
		S = "wistia-player-";
	class h extends m.Component {
		constructor() {
			super(...arguments),
				s(this, "callPlayer", y.callPlayer),
				s(
					this,
					"playerID",
		...
		load(e) {
			...
			(0, y.getSDK)(D, E).then((q) => {
				d.customControls &&
					d.customControls.forEach((_) => q.defineControl(_)),
		...
		render() {
			const { url: e } = this.props,
				a = e && e.match(g.MATCH_URL_WISTIA)[1],
				l = `wistia_embed wistia_async_${a}`,
	...
	return (
		s(h, "displayName", "Wistia"),
		s(h, "canPlay", g.canPlay.wistia),
		s(h, "loopOnEnded", !0),
		P
	);
}
var w = N();
const T = M(w),
	F = L({ __proto__: null, default: T }, [w]);
export { F as W };
